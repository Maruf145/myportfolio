...
<html lang="en">
    <head>
        ...
        <style>
        header{
        background-image: url("pexels-hasan-albari-1229861.jpg")!important;
    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar rounded-circle mb-5" src="assets/img/117715114_924611298050124_868874071729756253_o.jpg" alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">I am Maruful islam</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Web Designer - Web Developer</p>
            </div>
        </header>